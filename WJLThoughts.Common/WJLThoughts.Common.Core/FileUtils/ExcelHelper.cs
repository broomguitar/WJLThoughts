...
namespace WJLThoughts.Common.Core.FileUtils
{
    ...
    public static class ExcelHelper
    {
        ...
        /// <param name="sheetIndex">表位置</param>
        /// <returns></returns>
        public static DataTable ExcelToDataTable(string file, int sheetIndex = 0)
        {
        ...
        public static void IListToExcel<T>(IList<T> list, string file) where T : class
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                for (int j = 0; j < properties.Length; j++)
                {
                    ...
                    SetCellValue(cell, properties[j].GetValue(list[i]));
                }
            }
            //转为字节数组  
